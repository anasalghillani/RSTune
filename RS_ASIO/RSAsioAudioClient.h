...
private:
	...
	// RSTune: pitch shifts the guitar signal on its way in to the game
	void SetupRSTune();
	void ProcessRSTune(ASIOSampleType gameSampleType, WORD gameSampleTypeSize);
	...
	// RSTune state, one shifter per wasapi channel of a non-microphone input
